...
import { WrSquircleDirective } from './wr-squircle.directive';
...
@Component({
  ...
  hostDirectives: [{ directive: WrSquircleDirective, inputs: ['radius', 'smoothing'] }],
})
export class WrSquircleComponent {}
