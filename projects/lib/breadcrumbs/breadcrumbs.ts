...
import { WrBreadcrumbItem } from './breadcrumb-item';
...
@Component({
  ...
  imports: [WrBreadcrumbItem, RouterLink],
  providers: [
    {
      provide: WR_BREADCRUMBS,
      // eslint-disable-next-line @angular-eslint/no-forward-ref
      useExisting: forwardRef(() => WrBreadcrumbs),
    },
  ],
})
export class WrBreadcrumbs implements WrBreadcrumbsContext {
