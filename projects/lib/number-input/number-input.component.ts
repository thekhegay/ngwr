...
import { WrInputDirective, WrInputGroupComponent, WrInputPrefixDirective, WrInputSuffixDirective } from 'ngwr/input';
...
@Component({
  ...
  host: { '[class]': 'classes()' },
  imports: [WrInputDirective, WrInputGroupComponent, WrInputPrefixDirective, WrInputSuffixDirective],
  providers: [
    {
