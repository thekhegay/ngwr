...
import { WrColorPickerComponent } from './color-picker.component';
...
export class WrColorPickerTriggerDirective {
  ...
  open(): void {
    ...
    const portal = new ComponentPortal(WrColorPickerComponent, this.vcr);
