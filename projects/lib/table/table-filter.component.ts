...
import { WrIconComponent, checkmark, filter as filterIcon, provideWrIcons } from 'ngwr/icon';
...
@Component({
  ...
  host: { '[class]': 'classes()' },
  imports: [WrIconComponent, WrDropdownDirective, WrDropdownMenuComponent],
  providers: [provideWrIcons([checkmark, filterIcon])],
})
export class WrTableFilterComponent {
