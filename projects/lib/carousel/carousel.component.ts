...
import { WrCarouselSlideComponent } from './carousel-slide.component';
...
export class WrCarouselComponent {
  ...
  protected readonly slides = contentChildren(WrCarouselSlideComponent);
