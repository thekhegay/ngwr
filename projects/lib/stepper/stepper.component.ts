...
import { WrStepComponent } from './step.component';
  ...
  providers: [
    {
      ...
      useExisting: forwardRef(() => WrStepperComponent),
    },
  ],
})
export class WrStepperComponent implements WrStepperContext {
  ...
  protected readonly steps = contentChildren(WrStepComponent);
