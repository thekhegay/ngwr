...
import { WrCalendarComponent } from 'ngwr/calendar';
 ...
 * {@link WrDateTimePickerComponent} — not part of the public API.
 *
 * @internal
 */
@Component({
  selector: 'wr-date-time-panel',
  templateUrl: './date-time-panel.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
  encapsulation: ViewEncapsulation.None,
  host: { class: 'wr-date-time-panel' },
  imports: [FormsModule, WrCalendarComponent, WrTimePickerComponent],
})
export class WrDateTimePanelComponent {
