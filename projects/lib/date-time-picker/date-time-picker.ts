...
import { WrDateTimePanel } from './date-time-panel';
  ...
  providers: [
    {
      ...
      useExisting: forwardRef(() => WrDateTimePicker),
      multi: true,
    },
  ],
})
export class WrDateTimePicker implements ControlValueAccessor {
  ...
  private openOverlay(): void {
    ...
    const portal = new ComponentPortal(WrDateTimePanel);
