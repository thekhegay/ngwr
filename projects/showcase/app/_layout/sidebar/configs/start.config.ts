 ...
 * (see `routing.ts`).
 */
// Ordered by the path a new user actually walks: decide, try, trust, then
// install the package, wire the providers, and learn the CLI shortcut that
// automates both. Migration sits last — it is the page you come back to, not
