...
export const API = {
  ...
  WrSelect: [
    ...
    { name: "clearable", description: "Show a clear-all (×) button at the end of the chip row when at least one option is selected (multi mode only).", type: "boolean", default: "true" },
