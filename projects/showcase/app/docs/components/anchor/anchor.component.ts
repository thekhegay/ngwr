...
import { WrAnchorComponent, type WrAnchorLink } from 'ngwr/anchor';
...
@Component({
  ...
  imports: [WrAnchorComponent, DocPageComponent, DocSectionComponent, DocSnippetComponent, DocCodeComponent],
})
