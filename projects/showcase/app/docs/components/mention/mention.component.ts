...
import { WrMentionDirective, type WrMentionItem } from 'ngwr/mention';
...
export default class MentionPageComponent {
  ...
  protected readonly snippets = {
    install: `import { WrMentionDirective, type WrMentionItem } from 'ngwr/mention';

@Component({ imports: [WrMentionDirective, FormsModule] })
