...
import { WrStepComponent, WrStepperComponent } from 'ngwr/stepper';
...
export default class StepperPageComponent {
  ...
  protected readonly linearStepper = viewChild<WrStepperComponent>('linearStepper');
  ...
  protected readonly snippets = {
    install: `import { WrStepperComponent, WrStepComponent } from 'ngwr/stepper';

@Component({ imports: [WrStepperComponent, WrStepComponent] })
