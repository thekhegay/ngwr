...
import { WrBarChartComponent } from 'ngwr/bar-chart';
import { WrCalendarHeatmapComponent, type WrHeatmapDatum } from 'ngwr/calendar-heatmap';
import { WrDonutChartComponent } from 'ngwr/donut-chart';
import { WrGaugeComponent } from 'ngwr/gauge';
import { WrLineChartComponent } from 'ngwr/line-chart';
import { WrSparklineComponent } from 'ngwr/sparkline';
...
@Component({
  ...
  imports: [
    WrSparklineComponent,
    WrGaugeComponent,
    WrBarChartComponent,
    WrDonutChartComponent,
    WrLineChartComponent,
    WrCalendarHeatmapComponent,
    DocPageComponent,
    DocSectionComponent,
    DocSnippetComponent,
    DocCodeComponent,
