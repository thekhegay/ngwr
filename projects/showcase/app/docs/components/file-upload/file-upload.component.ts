...
import { WrFileUploadComponent, type WrFileUploadRejection } from 'ngwr/file-upload';
...
export default class FileUploadPageComponent {
  ...
  protected readonly snippets = {
    install: `import { WrFileUploadComponent } from 'ngwr/file-upload';

@Component({ imports: [WrFileUploadComponent, FormsModule] })
