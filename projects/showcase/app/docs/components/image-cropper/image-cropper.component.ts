...
import { WrImageCropperComponent } from 'ngwr/image-cropper';
...
export default class ImageCropperPageComponent {
  ...
  protected readonly snippets = {
    install: `import { WrImageCropperComponent } from 'ngwr/image-cropper';

@Component({ imports: [WrImageCropperComponent] })
