...
import { WrTabComponent, WrTabsComponent } from 'ngwr/tabs';
...
export default class TabsPageComponent {
  ...
  protected readonly snippets = {
    install: `import { WrTabsComponent, WrTabComponent } from 'ngwr/tabs';

@Component({ imports: [WrTabsComponent, WrTabComponent] })
