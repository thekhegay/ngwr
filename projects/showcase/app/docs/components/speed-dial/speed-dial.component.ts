...
import { WrSpeedDialComponent } from 'ngwr/speed-dial';
...
@Component({
  ...
  imports: [WrSpeedDialComponent, DocPageComponent, DocSectionComponent, DocSnippetComponent, DocCodeComponent],
