...
import { WrDateTimePickerComponent } from 'ngwr/date-time-picker';
...
export default class DateTimePickerPageComponent {
  ...
  protected readonly snippets = {
    install: `import { WrDateTimePickerComponent } from 'ngwr/date-time-picker';
...
@Component({ imports: [WrDateTimePickerComponent, FormsModule] })
