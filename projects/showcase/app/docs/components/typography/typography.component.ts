...
export default class TypographyPageComponent {
  protected readonly snippets = {
    install: `import { WrTypographyDirective } from 'ngwr/typography';

@Component({ imports: [WrTypographyDirective] })
export class MyComponent {}`,
    variants: `<h1 wrTypography variant="display">Display</h1>
<h1 wrTypography>Heading 1</h1>
...
<code wrTypography variant="code">code()</code>`,
    tones: `<p wrTypography tone="primary">Primary</p>
...
<p wrTypography tone="medium">Muted</p>`,
    modifiers: `<p wrTypography align="center">Centered</p>
<span wrTypography [truncate]="true" style="max-width: 16rem">
