...
import { WrDatePickerComponent } from 'ngwr/date-picker';
...
export default class DatePickerPageComponent {
  ...
  protected readonly snippets = {
    install: `import { WrDatePickerComponent } from 'ngwr/date-picker';
...
@Component({ imports: [WrDatePickerComponent, FormsModule] })
