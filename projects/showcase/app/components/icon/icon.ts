...
export default class IconComponent {
  ...
  protected readonly snippets = {
    install: `import { WrIcon } from 'ngwr/icon';
...
bootstrapApplication(AppComponent, {
  providers: [provideWrIcons([logoAngular])],
    ...
    registerComponent: `import { provideWrIcons, WrIcon, logoGithub, logoNpm } from 'ngwr/icon';
...
export class HeaderComponent {}`,
    custom: `import type { WrIconDef } from 'ngwr/icon';

export const myBrand: WrIconDef = {
  name: 'my-brand',
  data: '<svg viewBox="0 0 24 24" fill="currentColor"><path d="..." /></svg>',
};`,
    customRegister: `import { provideWrIcons, WrIcon } from 'ngwr/icon';
