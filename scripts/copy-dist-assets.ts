...
/**
 * Copies repository-level publishing assets (README + LICENSE) into the
 * lib's ng-packagr output so `dist/lib` is publish-ready out of the box.
 *
...
const ASSETS = ['README.md', 'LICENSE'] as const;
