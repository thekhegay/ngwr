...
possible violation, email **rk@garuna.dev** with the subject
`[conduct] <short description>`.

**Who reads it.** Roman Khegay, who maintains this project. "Community
Moderators" appears throughout the text below because that is the Covenant's
wording; here it is one person, and saying so is more useful than implying a
team that does not exist. Reports are not shared beyond that unless a resolution
requires it.

**What to expect.** An acknowledgement within 72 hours and an initial response
within 7 days — the same targets [`SECURITY.md`](./SECURITY.md) sets for a
vulnerability report, and set here for the same reason: someone who has just
reported an incident should know when to expect an answer rather than guess.
Investigations take as long as they take; the targets are for the reply, not the
outcome.
